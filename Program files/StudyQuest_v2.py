...
class MainApp(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("StudyQuest | Team 3 | SDEV265 Spring 2026")
    ...
    def _build_ui(self):
        ...
        ttk.Label(filter_row, text="Filter:", style="Small.TLabel").grid(row=0, column=0, sticky="w", padx=(0, 8))
        ...
        ttk.Label(filter_row, text="Search:", style="Small.TLabel").grid(row=0, column=4, sticky="e", padx=(0, 8))
