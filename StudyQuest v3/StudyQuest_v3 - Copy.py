...
Implementation details:
    ...
    Backup file: studyquest_save.txt.bak (also in current working directory)
...
class MainApp(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("StudyQuest v3.0 | Team 3 | SDEV265 Spring 2026")
    ...
    def _build_ui(self):
        ...
        ttk.Label(filter_row, text="Filter:", style="Small.TLabel").grid(row=0, column=0, sticky="w", padx=(2, 8))
        ...
        try:
            if os.path.exists(path):
                ...
                try:
                    ...
                    # Non-fatal: if we cannot remove bak, ignore (it can be removed manually)
                    pass
